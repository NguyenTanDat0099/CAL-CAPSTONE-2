...
export function Settings({ profile, setProfile }: SettingsProps) {
  ...
  return (
    <div className="flex-1 p-4 lg:p-10 min-h-screen bg-bg-dark text-white relative overflow-y-auto">
      <header className="mt-16 lg:mt-0 mb-10 flex items-center justify-between">
        <div className="flex items-center gap-2 text-text-muted text-xs lg:text-sm font-bold uppercase tracking-widest">
          <span>Setting</span>
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-8">
          <div className="flex flex-col sm:flex-row items-center gap-6 lg:gap-8">
            <div className="relative group">
              <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-[2rem] overflow-hidden border-2 border-brand-orange/20 p-1">
                <img 
                  src={profile.avatar} 
                  alt={profile.name} 
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 lg:-bottom-2 lg:-right-2 w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-brand-orange text-bg-dark flex items-center justify-center shadow-lg border-2 lg:border-4 border-bg-dark hover:scale-105 transition-transform"
                aria-label="Edit profile photo"
              >
                <Camera size={14} className="lg:hidden" />
                <Camera size={18} className="hidden lg:block" />
              </button>
            </div>
            <div className="text-center sm:text-left">
              <h1 className="text-4xl lg:text-6xl font-black tracking-tighter mb-2">{profile.name}</h1>
          ...
          <motion.button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-surface-lighter border border-white/5 text-sm font-bold hover:bg-white/5 transition-colors"
          >
        ...
        <div className="grid grid-cols-12 gap-8 pb-20">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            {/* Personal Narrative */}
            <section className="bg-surface-dark/30 rounded-[2.5rem] p-6 lg:p-10 border border-white/5 relative overflow-hidden">
              <Quote className="absolute top-8 right-8 text-white/5 w-16 h-16 lg:w-24 lg:h-24" />
              <div className="relative z-10">
                <p className="text-[10px] font-black uppercase tracking-widest text-text-muted mb-4 lg:mb-6">Personal Narrative</p>
                <p className="text-xl lg:text-2xl font-medium leading-relaxed italic text-white/90">
                  "{narrative}"
                </p>
              </div>
            </section>
            ...
            <div className="grid grid-cols-2 gap-4 lg:gap-6">
              {/* Age */}
              <div className="bg-surface-dark/30 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-8 border border-white/5 relative group">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl lg:text-4xl font-black">{profile.age}</span>
                  <span className="text-xs lg:text-sm font-bold text-text-muted">years</span>
                </div>
              </div>
              ...
              <div className="bg-surface-dark/30 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-8 border border-white/5 relative group">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl lg:text-4xl font-black">{profile.height}</span>
                  <span className="text-xs lg:text-sm font-bold text-text-muted">cm</span>
                </div>
              </div>
              ...
              <div className="bg-surface-dark/30 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-8 border border-white/5 relative group">
                ...
                <span className="text-3xl lg:text-4xl font-black capitalize">{profile.gender}</span>
              </div>
              ...
              <div className="bg-surface-dark/30 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-8 border border-white/5 relative group">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl lg:text-4xl font-black">{profile.weight}</span>
                  <span className="text-xs lg:text-sm font-bold text-text-muted">kg</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-8">
            {/* Current Objective */}
            <section className="bg-brand-orange rounded-[2.5rem] p-8 lg:p-10 text-bg-dark relative overflow-hidden">
              <div className="relative z-10">
                <p className="text-[10px] font-black uppercase tracking-widest opacity-60 mb-4">Current Objective</p>
                <h3 className="text-3xl lg:text-4xl font-black mb-8 lg:mb-12">
                  {objectiveLabel}
                </h3>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-2xl lg:text-3xl font-black">{progressPercentage}%</span>
                  </div>
            ...
            {/* Activity Level */}
            <section className="bg-surface-dark/30 rounded-[2.5rem] p-8 lg:p-10 border border-white/5 relative overflow-hidden">
              <Zap className="absolute -bottom-4 -right-4 text-white/5 w-24 h-24 lg:w-32 lg:h-32" />
              <div className="relative z-10">
                <p className="text-[10px] font-black uppercase tracking-widest text-text-muted mb-4">Activity Level</p>
                <h3 className="text-2xl lg:text-3xl font-black mb-4 capitalize">
        ...
        {isEditing && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 lg:p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-surface-dark border border-white/10 rounded-[2.5rem] lg:rounded-[3rem] shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
            >
              <div className="p-6 lg:p-10">
                <div className="flex justify-between items-center mb-8 lg:mb-10">
                  <h2 className="text-2xl lg:text-3xl font-black">Edit Profile</h2>
                ...
                <div className="space-y-6 lg:space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    <div className="relative group shrink-0">
                      <div className="w-20 h-24 lg:w-24 lg:h-24 rounded-[1.5rem] overflow-hidden border border-white/10">
                      ...
                      <div className="flex bg-bg-dark border border-white/10 rounded-2xl p-1">
                        {(['male', 'female'] as const).map((g) => (
                          <button
                            ...
                            className={`flex-1 py-3 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-widest transition-all ${
                  ...
                  <div className="pt-6 flex flex-col sm:flex-row gap-4">
                    <button 
                      onClick={handleCancel}
                      className="order-2 sm:order-1 flex-1 py-4 rounded-2xl bg-white/5 text-sm font-bold hover:bg-white/10 transition-colors"
                    >
                      Cancel
                    </button>
                    <button 
                      onClick={handleSave}
                      className="order-1 sm:order-2 flex-1 py-4 rounded-2xl bg-brand-orange text-bg-dark font-black shadow-lg shadow-brand-orange/20"
                    >
                      Save Changes
                    </button>
                  </div>
